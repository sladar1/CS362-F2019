...
int main(int argc, char* argv[]){
    ...
    ///////////////////////////////////////////////////////////////
    // TEST 1: Adding 2 Treasure cards to the next player's deck //
    ...
    playTribute(&G, player, player+1, 0);
    ...
    //////////////////////////////////////////////////////////////
    // TEST 2: Adding 2 Victory cards to the next player's deck //
    printf("\nTEST #2: One Estate and one Duchy for Tribute (Victory)\n");
    ...
    /////////////////////////////////////////////////////////////
    // TEST 3: Adding 2 Action cards to the next player's deck //
    printf("\nTEST #3: One Minion and one Mine for Tribute (Action)\n");
    ...
    printf("\nTEST #4: Two Coppers for Tribute (cards of same name)\n");
    playTribute(&G, player, player+1, 0);
    printf("04: Checking if coins are increased by 2 (+2 for each Treasure)...");
    assertCheck(G.coins, coinCheck);

    printf("\n~TRIBUTE TESTS COMPLETE~\n\n");
}
